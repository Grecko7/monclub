 ...
 */
final class Version20191030135303 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE joueur CHANGE libre libre INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE joueur CHANGE libre libre TINYINT(1) NOT NULL');
    }
}
